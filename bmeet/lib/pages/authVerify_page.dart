...
class AuthVerify extends StatefulWidget {
  const AuthVerify({Key? key, required this.fioController, required this.nameCompanyController, required this.titleJobController, required this.mailController}) : super(key: key);
...
class _AuthVerifyState extends State<AuthVerify> {
  ...
  //     "username": widget.fioController.text,
  //     "phone": widget.mailController.text,
  //     "email": widget.nameCompanyController.text,
  //     "password": widget.titleJobController.text
  //   });
  //   if (result.ok) {
  //     setState(() {
                    ...
                    onPressed: () async {
                      ...
                      PhoneAuthCredential credential =
                          PhoneAuthProvider.credential(
                              verificationId: AuthPhone.verify, smsCode: code);
